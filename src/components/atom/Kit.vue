...
export default {
  ...
  computed: {
    ...
    getCssVars() {
      ...
      if (kit) {
        if (kit.shirt.colors.length > 1 && kit.pants.colors.length > 1) {
          ...
          kit.shirt.colors.length > 1 &&
          kit.pants.colors.length <= 1
        ) {
          return {
            "--bg-shirt-primary-color": kit.shirt.colors[0],
            "--bg-shirt-secundary-color": kit.shirt.colors[1],
    ...
    getKitStyle() {
      let kit;
      if (this.isHome) {
        kit = this.myKit.home.shirt;
      } else {
        kit = this.myKit.away.shirt;
      }
...
.football-kit--stripes .football-kit__shirt {
  background: repeating-linear-gradient(
    to right,
    var(--bg-shirt-primary-color),
    var(--bg-shirt-primary-color) 5px,
    var(--bg-shirt-secundary-color) 5px,
    var(--bg-shirt-secundary-color) 10px
  );
}
.football-kit--hoops .football-kit__shirt {
  background: linear-gradient(
    -90deg,
    var(--bg-shirt-primary-color),
    var(--bg-shirt-primary-color) 49%,
    var(--bg-shirt-secundary-color) 50%
  );
}
...
.football-kit--stripes .football-kit__shirt {
  background: repeating-linear-gradient(
    ...
    var(--bg-primary-color) 10px,
    var(--bg-secundary-color) 10px,
    var(--bg-secundary-color) 20px
  );
}
.football-kit--hoops .football-kit__shirt {
  background: linear-gradient(
    -90deg,
    var(--bg-primary-color),
    var(--bg-primary-color) 49%,
    var(--bg-secundary-color) 50%
  );
}
.football-kit__sleeve {
  width: 40px;
