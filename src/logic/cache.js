...
export const storeDatesInCache = (value) =>
  storeInLocalstorage(KEY_DATES, value);
...
export const storeThrottleDateInCache = (value) =>
  storeInLocalstorage(KEY_THROTTLE, value);
